  ...
  return (
    <div>
      <div className="relative h-2 rounded-full mt-1" style={{ backgroundColor: track }}>
        ...
        <div className="absolute rounded-full" style={{ left: "calc(" + startPct + "% - 5px)", top: -3, width: 10, height: 10, backgroundColor: light ? "#fff" : BC.ink, boxShadow: "0 0 0 2px " + fillColor }} title="Baseline"></div>
