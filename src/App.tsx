  ...
  return (
    <div>
      <div className="relative h-2 rounded-full mt-1" style={{ backgroundColor: track }}>
        ...
        <div className="absolute rounded-full" style={{ left: "calc(" + startPct + "% - 5px)", top: -3, width: 10, height: 10, backgroundColor: BC.mid, boxShadow: "0 0 0 2px #fff" }} title="Baseline"></div>
        <div className="absolute rounded-full" style={{ left: "calc(" + endPct + "% - 5px)", top: -3, width: 10, height: 10, backgroundColor: BC.mid, boxShadow: "0 0 0 2px #fff" }} title="Progress Check"></div>
      </div>
...
async function addPupil(sid, cid) {
  ...
  async function handleDownloadPdf(filenameBase) {
    ...
    try {
      ...
      for (let i = 0; i < cuts.length - 1; i++) {
        ...
        const sliceHeightPx = cuts[i + 1] - sliceTop;
    ...
    return (
      <div className="fb min-h-screen py-6 px-3" style={{ backgroundColor: BC.purple }}>
        ...
        <div className="max-w-2xl mx-auto mb-3 flex gap-2">
          ...
          <button onClick={() => handleDownloadPdf(school.name + " - " + scopeLabel)} disabled={downloadingPdf} className="flex-1 py-2.5 rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:opacity-90 disabled:opacity-60" style={pill(BC.lime, BC.ink)}><Printer size={16} />{downloadingPdf ? "Generating PDF…" : "Download PDF"}</button>
        </div>
        <div ref={reportRef} className="max-w-2xl mx-auto bg-white shadow-xl rounded-sm p-8">
          <div className="flex items-center justify-between pb-4 mb-5" style={{ borderBottom: "4px solid " + BC.mid }}>
            ...
            <div className="flex flex-col items-end">
              <img src="/activeme-logo.svg" alt="ActiveMe 360" className="h-11 w-auto" />
            </div>
          </div>
          ...
          {complete.length > 0 ? (() => {
            ...
            return (
              <div className="pdf-avoid-break rounded-2xl p-5 mb-4 text-white" style={{ backgroundColor: BC.ink }}>
          ...
          <div className="pdf-avoid-break mt-2 rounded-xl p-4 border" style={tintBox(BC.mid)}>
